            ...
            for block_type, x, y, params in creature.genome.blocks:
                if block_type == 'incubadora':
                    ...
                    if egg:
                        ...
                        # Crecimiento autónomo si es externo (0.2/tick = 150 ticks promedio para eclosionar)
    ...
    def tick(self):
        ...
        for creature in self.creatures:
            ...
            for block in creature.genome.blocks:
                ...
                dormir = creature.neurons.get(f"neuron_{block_type}_{x}_{y}_dormir", 0.0)
                ...
                # Si el bloque está dormido, reducir a 0.05 (solo metabolismo basal)
                if dormir > 0.5:
                    cost += base_cost * 0.5
                    continue  # No ejecutar funciones del bloque
